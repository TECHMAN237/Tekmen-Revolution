        ...
        >
          ...
          <div className="relative z-10 text-center mb-10">
            ...
            <h1 className="text-3xl sm:text-4xl font-display font-bold text-white mb-4">
              Accès au projet <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">SAFECHILD</span>
            </h1>
          ...
          <div className="bg-black/40 border border-white/5 rounded-2xl p-6 sm:p-8 mb-10 relative z-10">
            <h3 className="text-lg font-semibold text-white flex items-center gap-2 mb-6">
              <Key className="w-5 h-5 text-purple-400" /> Coordonnées d'accès
            </h3>
          ...
          <div className="text-center relative z-10">
            ...
            >
              Accéder à la plateforme <ExternalLink className="w-5 h-5" />
            </a>
