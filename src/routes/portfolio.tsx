...
function PortfolioNavbar() {
  ...
  return (
    ...
    >
      <div
        className={`w-full max-w-7xl transition-all duration-500 pointer-events-auto flex items-center justify-between ${
          scrolled
            ? "bg-black/70 backdrop-blur-md border border-white/10 shadow-lg py-3 px-4 rounded-full"
      ...
      >
        ...
        <div className="flex flex-wrap justify-center gap-2 sm:gap-4">
          <a
            href="#graphic-design"
            className="px-3 sm:px-5 py-2 rounded-full hover:bg-white/10 text-xs sm:text-sm font-medium transition-all text-white"
          >
            🎨{" "}
            <span className="hidden md:inline">
              {isEn ? "Graphic Design" : "Graphic Design"}
            </span>
          </a>
          <a
            href="#video-editing"
          ...
          >
            🎬{" "}
            <span className="hidden md:inline">
              {isEn ? "Video Editing" : "Montage Vidéo"}
            </span>
          </a>
          <a
            href="#web-dev"
