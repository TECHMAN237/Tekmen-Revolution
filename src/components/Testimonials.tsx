...
const testimonials: Testimonial[] = [
  {
    id: 1,
    name: "Danielle Kenmogne",
    role: "Fondatrice & Décoratrice",
    company: "Home Joy Déco 237",
    avatar: "",
    rating: 5,
    text: "TEKMEN REVOLUTION a sublimé l'image de marque de Home Joy Déco 237 ! Leurs montages vidéo et contenus digitaux ont boosté notre visibilité auprès de nos clients au Cameroun. Un travail d'une créativité exceptionnelle.",
    projectType: "Vidéo",
  },
  {
    id: 2,
    ...
    company: "JK Révolution",
    avatar: "",
    rating: 5,
    text: "La collaboration avec TEKMEN REVOLUTION a été déterminante pour JK Révolution. Des solutions digitales innovantes, une réactivité sans faille et une rigueur remarquable. Je recommande vivement leurs services.",
    projectType: "Application Web",
  },
  {
    id: 3,
    name: "Emmanuel Tchatchoua",
    role: "Directeur Artistique",
    company: "Douala Vision Lab",
    avatar: "",
    rating: 5,
    text: "Les flyers et visuels graphiques créés par TEKMEN dépassent toujours nos attentes. Leur sens aigu du détail et leur créativité percutante font toute la différence sur le marché camerounais.",
  ...
  },
  {
    ...
    company: "Kmer Shop Express",
    avatar: "",
    rating: 5,
    text: "Notre boutique en ligne a connu un envol spectaculaire grâce au développement web sur-mesure et à l'ergonomie pensée par TEKMEN. Nos clients adorent la rapidité de la plateforme.",
    projectType: "E-commerce",
  },
  {
    id: 5,
    name: "Marc-Aurèle Nguemo",
    role: "CEO & Co-Fondateur",
    company: "Sawa Tech Solutions",
    avatar: "",
    rating: 5,
    text: "Travailler avec TEKMEN REVOLUTION est un plaisir. Une équipe à l'écoute qui maîtrise parfaitement les technologies modernes et sait s'adapter aux besoins spécifiques de nos entreprises locales.",
  ...
  },
  {
    ...
    company: "Yaoundé Digital Pulse",
    avatar: "",
    rating: 5,
    text: "Leurs productions vidéo et animations ont généré un engagement record sur nos réseaux sociaux. Le dynamisme et la modernité des montages reflètent exactement l'énergie de notre marque.",
    projectType: "Vidéo",
  },
];
