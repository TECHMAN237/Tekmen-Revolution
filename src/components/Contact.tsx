...
const SiWhatsapp = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
const SiGithub = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
...
const SiPhone = (props: React.SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        setStatusMessage(
          data.errors?.[0] ||
            data.error ||
            t(translations.contact.errorDefault),
        );
      }
    } catch (err) {
      // 5. Network error
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 relative z-10">
        ...
        <div className="text-center mb-16 sm:mb-24">
          ...
          >
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-indigo-400 to-purple-600">
              {t(translations.contact.titleHighlight)}
            </span>
          </motion.h2>
          <motion.p
            ...
            <form onSubmit={handleSubmit} className="space-y-7 relative z-10">
              ...
              <div className="space-y-2.5">
                <label
                  ...
                  className="text-xs font-black tracking-widest text-white/50 ml-2 uppercase"
                >
                  {t(translations.contact.labelName)}
                </label>
                <input
                  type="text"
                  id="contact-name"
              ...
              <div className="space-y-2.5">
                <label
                  ...
                  className="text-xs font-black tracking-widest text-white/50 ml-2 uppercase"
                >
                  {t(translations.contact.labelEmail)}
                </label>
                <input
                  type="email"
                  id="contact-email"
              ...
              <div className="space-y-2.5">
                <label
                  ...
                  className="text-xs font-black tracking-widest text-white/50 ml-2 uppercase"
                >
                  {t(translations.contact.labelMessage)}
                </label>
                <textarea
                  id="contact-message"
                  rows={4}
          ...
          <div className="flex flex-col gap-6 h-full">
            ...
            >
              <div className="grid grid-cols-2 gap-4 sm:gap-6">
                {contactCards.map((card, idx) => (
                  ...
                  >
                    <div
                      className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full flex items-center justify-center mb-3 ${card.color} text-white shadow-[0_10px_20px_-5px_rgba(0,0,0,0.3)] group-hover:scale-110 transition-all duration-500 relative z-10`}
                    >
            ...
            >
              <div className="flex flex-col sm:flex-row items-center text-center sm:text-left gap-4 sm:gap-6">
                ...
                <div>
                  <h4 className="text-base sm:text-lg text-white font-bold tracking-tight">
                    {t(translations.contact.readyToStart)}
                  </h4>
                  <p className="text-xs sm:text-sm text-muted-foreground/70 font-light mt-1">
                    {t(translations.contact.talkAboutProject)}
                  </p>
                </div>
              </div>
