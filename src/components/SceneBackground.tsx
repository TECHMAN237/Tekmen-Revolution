...
export function SceneBackground() {
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-[-10%] left-[-10%] w-[70%] h-[70%] rounded-full bg-cyan-950/20 blur-[80px] opacity-60"
        style={{ transform: "translateZ(0)" }}
      />
      <div
        className="absolute bottom-[-10%] right-[-10%] w-[60%] h-[60%] rounded-full bg-purple-950/15 blur-[80px] opacity-40"
        style={{ transform: "translateZ(0)" }}
      />
      <div
        className="absolute top-[20%] right-[10%] w-[50%] h-[50%] rounded-full bg-blue-950/10 blur-[90px] opacity-30"
        style={{ transform: "translateZ(0)" }}
      />
